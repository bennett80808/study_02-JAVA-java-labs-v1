...
public class StringLab {
    public static void main(String[] args) {
        ...
        System.out.println("'" + target + "' 문자의 등장 횟수: " + count);
        ...
        StringBuilder sbPalindrome = new StringBuilder(palindrome);
        reversed = sbPalindrome.reverse().toString();
        if(palindrome.equals(reversed)) {System.out.println("같음");}
